...
To formally answer the hypotheses, we compute contrasts of the marginal posteriors. First, we need the intercept-only draws and associated levels.
...
Contrary to our hypothesis, donors showed decreased willingness to donate to NGOs that are facing government crackdown or criticism relative to NGOs that have a friendly relationship with the government, with this decreased likelihood to donate greater for NGOs under crackdown compared to those being criticized.
...
contrasts_int <- tibble(
  ...
  mutate(
    ...
    "criticized red cross - criticized green peace" = 
...
Although donors show significantly more willingness to donate to Red Cross when they are criticized or under crackdown from the host government, donors are less likely to donate to Oxfam under the same conditions. The only contrast which isn't statistically significant is the difference between Oxfam and Amnesty when both are under crackdown.
...
contrasts_int <- tibble(
  ...
  mutate(
    "criticized emergency - criticized environment" = 
      (criticized) - (criticized + environment + criticized_environment),
    "criticized emergency - criticized human rights" = 
      (criticized) - (criticized + human_rights + criticized_human_rights),
    "crackdown emergency - crackdown environment" = 
      (crackdown) - (crackdown + environment + crackdown_environment),
    "crackdown emergency - crackdown human rights" = 
      (crackdown) - (crackdown + human_rights + crackdown_human_rights),
    "criticized refugee relief - criticized environment" = 
      (criticized + refugee_relief + criticized_refugee) - (criticized + environment + criticized_environment),
    "criticized refugee relief - criticized human rights" = 
      (criticized + refugee_relief + criticized_refugee) - (criticized + human_rights + criticized_human_rights),
    "crackdown refugee relief - crackdown environment" = 
      (crackdown + refugee_relief + crackdown_refugee) - (crackdown + environment + crackdown_environment),
    "crackdown refugee relief - crackdown human rights" = 
      (crackdown + refugee_relief + crackdown_refugee) - (crackdown + human_rights + crackdown_human_rights)
  )

# Plot the contrasts
contrasts_int %>%
  pivot_longer(
    "criticized emergency - criticized environment":"crackdown refugee relief - crackdown human rights", 
    names_to = "level", values_to = "Gamma"
  ) %>% 
  ggplot(aes(x = Gamma, y = level)) +
  stat_halfeye(.width = .95) +
...
Per our hypothesis, we expected to see the contrasts of the posterior distributions to be positive. However, only the contrasts between emergency response and the more contentious issue areas (environment and human rights) were positive, while contrasts between refugee relief and the more contentious issue areas were negative. Here the issue area itself matters far more than the relationship with the host government.
...
Donors indeed show increased willingness to donate to NGOs funded by numerous small private donors, as opposed to those funded by a handful of wealthy private donors or government grants.
...
contrasts_int <- tibble(
  ...
  "criticized small donors - criticized wealthy donors" = 
    (criticized) - (few_wealthy_private_donors + criticized + criticized_wealthydonors),
  "criticized small donors - criticized government grants" = 
    (criticized) - (government_grants + criticized + criticized_grants),
  "crackdown small donors - crackdown wealthy donors" = 
    (crackdown) - (few_wealthy_private_donors + crackdown + crackdown_wealthydonors),
  "crackdown small donors - crackdown government grants" = 
    (crackdown) - (government_grants + crackdown + crackdown_grants)
  )

# Plot the contrasts
contrasts_int %>%
  pivot_longer(
    "criticized small donors - criticized wealthy donors":"crackdown small donors - crackdown government grants", 
    names_to = "level", values_to = "Gamma"
  ) %>% 
  ggplot(aes(x = Gamma, y = level)) +
  stat_halfeye(.width = .95) +
...
All of the contrasts are positive and significant, which supports our hypothesis that donors are more willing to donate to organizations supported by many small private donors and are under criticism or crackdown.
