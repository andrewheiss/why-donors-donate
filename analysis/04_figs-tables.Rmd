...
contrasts_int <- tibble(
  ...
  mutate(
    oxfam_amnesty_criticized = oxfam_criticized - amnesty_criticized,
    oxfam_greenpeace_criticized = oxfam_criticized - greenpeace_criticized,
    red_cross_amnesty_criticized = red_cross_criticized - amnesty_criticized,
    red_cross_greenpeace_criticized = red_cross_criticized - greenpeace_criticized,
    oxfam_amnesty_crackdown = oxfam_crackdown - amnesty_crackdown,
    oxfam_greenpeace_crackdown = oxfam_crackdown - greenpeace_crackdown,
    red_cross_amnesty_crackdown = red_cross_crackdown - amnesty_crackdown,
    red_cross_greenpeace_crackdown = red_cross_crackdown - greenpeace_crackdown
  )
# Plot the contrasts
contrasts_int %>%
