...
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_2b.rds")
...
```{r issue-contrasts-b}
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_3b.rds")
...
contrasts_int <- tibble(
  criticized_environment = draws %>% filter(i == 22) %>% select(Gamma) %>% pull(),
  criticized_humanrights = draws %>% filter(i == 23) %>% select(Gamma) %>% pull(),
  criticized_refugee = draws %>% filter(i == 24) %>% select(Gamma) %>% pull(),
  crackdown_environment = draws %>% filter(i == 25) %>% select(Gamma) %>% pull(),
  crackdown_humanrights = draws %>% filter(i == 26) %>% select(Gamma) %>% pull(),
  crackdown_refugee = draws %>% filter(i == 27) %>% select(Gamma) %>% pull(),
) %>% 
  mutate(
...
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_4b.rds")
...
contrasts_int <- tibble(
  criticized_wealthydonors = draws %>% filter(i == 28) %>% select(Gamma) %>% pull(),
  criticized_grants = draws %>% filter(i == 29) %>% select(Gamma) %>% pull(),
  crackdown_wealthydonors = draws %>% filter(i == 30) %>% select(Gamma) %>% pull(),
  crackdown_grants = draws %>% filter(i == 31) %>% select(Gamma) %>% pull(),
)
...
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_4c.rds")
...
contrasts_int <- tibble(
  emergency_crackdown_wealthydonors = draws %>% filter(i == 32) %>% select(Gamma) %>% pull(),
  emergency_crackdown_grants = draws %>% filter(i == 33) %>% select(Gamma) %>% pull(),
  environment_crackdown_wealthydonors = draws %>% filter(i == 34) %>% select(Gamma) %>% pull(),
  environment_crackdown_grants = draws %>% filter(i == 35) %>% select(Gamma) %>% pull(),
  humanrights_crackdown_wealthydonors = draws %>% filter(i == 36) %>% select(Gamma) %>% pull(),
  humanrights_crackdown_grants = draws %>% filter(i == 37) %>% select(Gamma) %>% pull(),
  refugee_crackdown_wealthydonors = draws %>% filter(i == 38) %>% select(Gamma) %>% pull(),
  refugee_crackdown_grants = draws %>% filter(i == 39) %>% select(Gamma) %>% pull(),
) %>% 
  mutate(
...
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_5b.rds")

# Pull the posterior draws for organizational practices*government crackdown interaction
# Reference Level = Friendly relationship with government

contrasts_int <- tibble(
  financial_transparency_criticized = draws %>% filter(i == 40) %>% select(Gamma) %>% pull(),
  financial_transparency_crackdown = draws %>% filter(i == 41) %>% select(Gamma) %>% pull(),
  )
...
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_5c.rds")
...
contrasts_int <- tibble(
  fin_smalldonors_criticized = draws %>% filter(i == 42) %>% select(Gamma) %>% pull(),
  fin_wealthydonors_criticized = draws %>% filter(i == 43) %>% select(Gamma) %>% pull(),
  fin_grants_criticized = draws %>% filter(i == 44) %>% select(Gamma) %>% pull(),
  fin_smalldonors_crackdown = draws %>% filter(i == 45) %>% select(Gamma) %>% pull(),
  fin_wealthydonors_crackdown = draws %>% filter(i == 46) %>% select(Gamma) %>% pull(),
  fin_grants_crackdown = draws %>% filter(i == 47) %>% select(Gamma) %>% pull(),
  ) %>%
  mutate(
...
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_5d.rds")
...
contrasts_int <- tibble(
  fin_emergency_criticized = draws %>% filter(i == 48) %>% select(Gamma) %>% pull(),
  fin_emergency_crackdown = draws %>% filter(i == 49) %>% select(Gamma) %>% pull(),
  fin_environment_criticized = draws %>% filter(i == 50) %>% select(Gamma) %>% pull(),
  fin_environment_crackdown = draws %>% filter(i == 51) %>% select(Gamma) %>% pull(),
  fin_humanrights_criticized = draws %>% filter(i == 52) %>% select(Gamma) %>% pull(),
  fin_humanrights_crackdown = draws %>% filter(i == 53) %>% select(Gamma) %>% pull(),
  fin_refugee_criticized = draws %>% filter(i == 54) %>% select(Gamma) %>% pull(),
  fin_refugee_crackdown = draws %>% filter(i == 55) %>% select(Gamma) %>% pull()
  ) %>%
  mutate(
...
# Overwrite draws with the appropriate interaction data
draws <- here::here("data", "raw_data", "posterior_draws", "interactions_5e.rds")
...
contrasts_int <- tibble(
  fin_sd_emergency_criticized = draws %>% filter(i == 56) %>% select(Gamma) %>% pull(),
  fin_sd_emergency_crackdown = draws %>% filter(i == 57) %>% select(Gamma) %>% pull(),
  fin_sd_environment_criticized = draws %>% filter(i == 58) %>% select(Gamma) %>% pull(),
  fin_sd_environment_crackdown = draws %>% filter(i == 59) %>% select(Gamma) %>% pull(),
  fin_sd_humanrights_criticized = draws %>% filter(i == 60) %>% select(Gamma) %>% pull(),
  fin_sd_humanrights_crackdown = draws %>% filter(i == 61) %>% select(Gamma) %>% pull(),
  fin_sd_refugee_criticized = draws %>% filter(i == 62) %>% select(Gamma) %>% pull(),
  fin_sd_refugee_crackdown = draws %>% filter(i == 63) %>% select(Gamma) %>% pull()
  ) %>%
  mutate(
