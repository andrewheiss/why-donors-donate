...
Market share when criticized:
A = 0.130767214
G = 0.212870677
O = 0.218368082
R = 0.437994028

Market share under crackdown:
A = 0.130767214
G = 0.212870677
O = 0.218368082
R = 0.437994028
...
Tentative yes, O and R claim greater market share compared to A and G
...
ER>RR>EV>HR, evidence that hypothesis is correct
...
numerous donors/not under crackdown = 0.247967551
numerous donors/under crackdown = 0.271016037
few donors/under crackdown = 0.26213647
government grants/under crackdown = 0.218879942

Though numerous donors/under crackdown has the largest market share, the difference between them is almost insignificant. Personally, this evidence doesn't seem convincing.

### Hypothesis 5, Organizational Practices

```{r practices-contrasts}
...
# Plot the contrasts
contrasts %>%
  pivot_longer(financial_transparency:accountability, names_to = "level", values_to = "Gamma") %>% 
  ggplot(aes(x = Gamma, y = level)) +
  stat_halfeye(.width = .95) +
  geom_vline(xintercept = 0, color = "grey") +
  labs(y = "Difference in Attribute Levels", x = "Difference in Gammas")
...
When comparing organizational practices, donors show an increased likelihood to donate to NGOs that are financially transparent as well as NGOs that are accountable and hold regular third party audits. Although financial transparency was hypothesized to increase donor's willingness to donate, we believed accountability practices would have an insignificant effect on influencing donor's willingness to donate; our analysis indicates that this is not the case.
...
Expected utility (Transparency/Few donors/Under crackdown):
...
Not sure if this is the best way to do triple interaction, but I gave it a shot. I included expected utility as well as market share, as market share may understate the difference in willingness to donate (market share is split between 7 orgs instead of 4). 

NGOs that are financially transparent, are supported by few donors, and are under crackdown receive the second largest share of the market--they are topped by firms which are transparent and under crackdown, but are supported by numerous donors. This would contradict the hypothesis, assuming I did this correctly.
...
Accountability = 0.566631341
No Accountability = 0.433368659

The difference is large enough to suggest that accountability increases donors likelihood to donate, contrary to the hypothesis.
## Model fit table
