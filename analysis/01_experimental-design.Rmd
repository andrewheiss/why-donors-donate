...
# Code all possible interactions

We have a number of hypotheses referencing specific interactions. To answer these hypotheses, we need to specify each of the needed interactions.
...
It's possible an index-coded design will serve us better, allowing us to compute whatever contrasts are needed from a single model. An index-coded design has no reference levels.
...
################################################################################
# This is an experimental alternative to the interactions based on the 
# dummy-coded design.
################################################################################
...
## Aggregate-coded interaction alternative

```{r aggregate-interactions, warning=FALSE, message=FALSE}
################################################################################
# This is an experimental alternative where specific contrasts are estimated
# as part of the model (hence aggregate-coded) rather than computed using
# marginal posteriors after estimation.
################################################################################
...
################################################################################
# Are we sure this is encoding the needed contrasts exactly??
################################################################################
...
# Sticking exactly to the hypotheses where each contrasts will 
# consist of h*_high - h*_low
interactions <- interactions %>% 
  as_tibble() %>% 
  rowwise() %>% 
  mutate(
