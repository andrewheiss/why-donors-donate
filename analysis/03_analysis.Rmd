...
if (public_affairs == 1) {
  covariate_labels <- c(
    ...
    "Follow government and public affairs: Most of the time to Hardly at all", "Traveled to a developing country: Yes to No"
  )
}
...
if (charity_voluntarism == 1) {
  covariate_labels <- c(
    ...
    "Donated last year: $1-$49 to $10,000 or more", "Volunteered in past 12 months: Yes to No", "Volunteer frequency: Weekly to Every few years",
...
if (demographics == 1) {
  covariate_labels <- c(
    "Gender: Male to Prefer not to say", "Marital status: Married to Never married", "Education: Less than high school to Doctorate",
