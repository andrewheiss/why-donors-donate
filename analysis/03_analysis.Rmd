...
if (intercept == 1 & interactions == 0) write_rds(run, here::here("data", "raw_data", "model_runs", "index_intercept.rds"))
if (intercept == 1 & interactions == 1) write_rds(run, here::here("data", "raw_data", "model_runs", "interactions_5e.rds"))
...
if (intercept == 1 & interactions == 0) run <- read_rds(here::here("data", "raw_data", "model_runs", "intercept.rds"))
if (intercept == 1 & interactions == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "interactions_5d.rds"))
if (public_affairs == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "public_affairs.rds"))
if (political_ideology == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "political_ideology.rds"))
if (social_views == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "social_views.rds"))
if (charity_voluntarism == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "charity_voluntarism.rds"))
if (demographics == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "demographics.rds"))
if (public_political == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "public_political.rds"))
if (public_political_social == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "public_political_social.rds"))
if (public_political_social_charity == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "public_political_social_charity.rds"))
if (public_political_social_charity_demo == 1) run <- read_rds(here::here("data", "raw_data", "model_runs", "public_political_social_charity_demo.rds"))
data <- run$data
fit <- run$fit
...
if (intercept == 1 & interactions == 1) write_rds(draws, here::here("data", "raw_data", "posterior_draws", "interactions_5d.rds"))
