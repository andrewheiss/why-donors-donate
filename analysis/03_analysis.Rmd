...
X <- read_rds(here::here("data", "derived_data", "mnl_index_design.rds"))
...
write_rds(run, here::here("data", "raw_data", "model_runs", "mnl_index_02.rds"))
...
write_rds(draws, here::here("data", "raw_data", "posterior_draws", "mnl_index_02.rds"))
