...
# 1. geom_ridgeline 
    # geom_ridgeline(fill = "blue") +
# 2. geom_density_ridges seems to be the better option for overlapping distributions.
    geom_density_ridges(scale = 5, height = 3, rel_min_height = 0.001) +
        # geom_density_ridges(scale = 3) - control overlap
        # geom_density_ridges2 - includes bottom line
        # geom_density_ridges(rel_min_height = 0.01) - shortens tails
    # geom_halfeyeh(.width = .95) +
