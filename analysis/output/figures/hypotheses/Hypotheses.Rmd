...
if (charity_voluntarism == 1) {
  covariate_labels <- c(
    "Importance of trusting charities: Not at all to Essential", "Trust in charities: None to Complete", "Donation frequency: Weekly to Never",
...
if (intercept != 1) {
    ...
    filter(
      ...
      covariates == str_c(
      c("Church or religious organization: ", "Sport or recreational organization: ", "Art, music, or educational organization: ",
        "Labor union: ", "Political party: ", "Environmental organization: ", "Professional association: ", 
        "Humanitarian or charitable organization: ", "Consumer organization: ", "Other organization: "
      ), 
      "Member to Not")) %>% 
