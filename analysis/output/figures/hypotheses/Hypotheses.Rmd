...
if (intercept != 1) {
    ...
    filter(
      levels ==   str_c("Issue area: ", c("Environment", "Human rights", "Refugee relief")),
      covariates == c("Religion: Hindu", "Religion: Protestant", "Religion: Christian Orthodox", "Religion: Jewish")) %>% 
