...
persona_data <- readxl::read_xlsx(here('analysis', 'output', "persona_configV07.xlsx"))

# Org Data from Market Simulator Workbook
org_data <- readxl::read_xlsx(here('analysis', 'output', "org_config.xlsx"))
...
df <- reactive({
  ...
  #Amnesty International
    ...
    beta$ai_value[beta$levels %in% input$org1_id] <- 1
  ...
  #Greenpeace
    ...
    beta$gp_value[beta$levels %in% input$org2_id] <- 1
  ...
  #Oxfam
    ...
    beta$ox_value[beta$levels %in% input$org3_id] <- 1
  ...
  #Redcross
    ...
    beta$rc_value[beta$levels %in% input$org4_id] <- 1
...
beta_persona$levels = c("Intercept",
                        ...
                        "Very little trust in polticial institutions",
                        "Little trust in polticial institutions",
                        "Nuetral trust in polticial institutions",
                        "Some trust in polticial institutions",
                        "A lot of trust in polticial institutions",
                        "Complete trust in polticial institutions",
...
p <- reactive({
  ...
  #Persona 1
    ...
    beta_persona$p1_value[beta_persona$levels == 'Intercept'] <- 1
  ...
  #Persona 2
    ...
    beta_persona$p2_value[beta_persona$levels == 'Intercept'] <- 1
  ...
  #Persona 3
    ...
    beta_persona$p3_value[beta_persona$levels == 'Intercept'] <- 1
...
# matrix multiplication between persona data and betas
beta1 <- as.matrix(public_political_social_charity_demo) %*% as.matrix(persona1)
...
# matrix multiplication between persona data and betas
beta2 <- as.matrix(public_political_social_charity_demo) %*% as.matrix(persona2)
...
# matrix multiplication between persona data and betas
beta3 <- as.matrix(public_political_social_charity_demo) %*% as.matrix(persona3)
...
# Expected utility matrix multiplication between computed persona betas and org data for persona 1
org1_exp_util1 <- exp(t(org1) %*% as.matrix(beta1))
org2_exp_util1 <- exp(t(org2) %*% as.matrix(beta1))
org3_exp_util1 <- exp(t(org3) %*% as.matrix(beta1))
org4_exp_util1 <- exp(t(org4) %*% as.matrix(beta1))
...
# org1_exp_util2 <- exp(t(org1) %*% as.matrix(p_beta2))
# org2_exp_util2 <- exp(t(org2) %*% as.matrix(p_beta2))
# org3_exp_util2 <- exp(t(org3) %*% as.matrix(p_beta2))
# org4_exp_util2 <- exp(t(org4) %*% as.matrix(p_beta2))
# 
# 
# org1_exp_util3 <- exp(t(org1) %*% as.matrix(p_beta3))
# org2_exp_util3 <- exp(t(org2) %*% as.matrix(p_beta3))
# org3_exp_util3 <- exp(t(org3) %*% as.matrix(p_beta3))
# org4_exp_util3 <- exp(t(org4) %*% as.matrix(p_beta3))
...
renderPlotly({
  ...
  # Expected Utility
  ai_exp_util1 <- exp(t(org_choice[, 3]) %*% as.matrix(p_beta1))
  gp_exp_util1 <- exp(t(org_choice[, 4]) %*% as.matrix(p_beta1))
  ox_exp_util1 <- exp(t(org_choice[, 5]) %*% as.matrix(p_beta1))
  rc_exp_util1 <- exp(t(org_choice[, 6]) %*% as.matrix(p_beta1))
  ...
  # Expected Utility
  ai_exp_util2 <- exp(t(org_choice[, 3]) %*% as.matrix(p_beta2))
  gp_exp_util2 <- exp(t(org_choice[, 4]) %*% as.matrix(p_beta2))
  ox_exp_util2 <- exp(t(org_choice[, 5]) %*% as.matrix(p_beta2))
  rc_exp_util2 <- exp(t(org_choice[, 6]) %*% as.matrix(p_beta2))
  ...
  # Expected Utility
  ai_exp_util3 <- exp(t(org_choice[, 3]) %*% as.matrix(p_beta3))
  gp_exp_util3 <- exp(t(org_choice[, 4]) %*% as.matrix(p_beta3))
  ox_exp_util3 <- exp(t(org_choice[, 5]) %*% as.matrix(p_beta3))
  rc_exp_util3 <- exp(t(org_choice[, 6]) %*% as.matrix(p_beta3))
  ...
  df[,2] <- rep(c(input$ai_id, input$gp_id, input$ox_id, input$rc_id),6)
  # Type of value
