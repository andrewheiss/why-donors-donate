...
organization_values <- reactiveValues()

organization_data <- reactive({
  if (is.null(input$org_update$datapath)) {
    organization_reactive <- read.csv(here::here('analysis', 'output', 'configurations', 'organization_config01.csv'))
    organization_values$file_name = "organization_config01.csv"
    organization_values$file_type = "csv"
    organization_values$file_size = file.size(here::here('analysis', 'output', 'configurations', 'organization_config01.csv'))
    organization_values$file_path = here::here('analysis', 'output', 'configurations', 'organization_config01.csv')
  } else {
    organization_data <- read.csv(input$org_update$datapath)
    organization_values$file_name = input$org_update$name
    organization_values$file_size = input$org_update$size
    organization_values$file_type = input$org_update$type
    organization_values$file_path = input$org_update$datapath
  }
})
...
renderUI({
  selectInput(
    ...
    # selected = "Red Cross",
    selected = as.character(organization_data()[1:4,][which(organization_data()[1:4,2] == 1), 1]),
    width = "450px"
  )
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[5:7,2]) == 0, "Emergency response",
    as.character(organization_data$data[5:7,][which(organization_data$data[5:7,2] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[8,2]) == 0, "Doesn’t engage in financial transparency",
    as.character(organization_data$data[8,][which(organization_data$data[8,2] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[9,2]) == 0, "Doesn’t engage in financial accountability",
    as.character(organization_data$data[9,][which(organization_data$data[9,2] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[10:11,2]) == 0, "Many small private donations",
    as.character(organization_data$data[10:11,][which(organization_data$data[10:11,2] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[12:13,2]) == 0, "Friendly relationship with government",
    as.character(organization_data$data[12:13,][which(organization_data$data[12:13,2] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  choice = c("Amnesty International", "Greenpeace", "Oxfam", "Red Cross"),
  # selected = "Red Cross",
  selected = as.character(organization_data$data[1:4,][which(organization_data$data[1:4,3] == 1), 1]),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[5:7,3]) == 0, "Emergency response",
    as.character(organization_data$data[5:7,][which(organization_data$data[5:7,3] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Engages in financial transparency",
  selected = ifelse(
    sum(organization_data$data[8,3]) == 0, "Doesn’t engage in financial transparency",
    as.character(organization_data$data[8,][which(organization_data$data[8,3] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Engages in financial accountability",
  selected = ifelse(
    sum(organization_data$data[9,3]) == 0, "Doesn’t engage in financial accountability",
    as.character(organization_data$data[9,][which(organization_data$data[9,3] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Many small private donations",
  selected = ifelse(
    sum(organization_data$data[10:11,3]) == 0, "Many small private donations",
    as.character(organization_data$data[10:11,][which(organization_data$data[10:11,3] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Friendly relationship with government",
  selected = ifelse(
    sum(organization_data$data[12:13,3]) == 0, "Friendly relationship with government",
    as.character(organization_data$data[12:13,][which(organization_data$data[12:13,3] == 1), 1])
  ),
  width = "450px"
)
})
...
selectInput(
  ...
  choice = c("Amnesty International", "Greenpeace", "Oxfam", "Red Cross"),
  # selected = "Red Cross",
  selected = as.character(organization_data$data[1:4,][which(organization_data$data[1:4,4] == 1), 1]),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[5:7,4]) == 0, "Emergency response",
    as.character(organization_data$data[5:7,][which(organization_data$data[5:7,4] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Engages in financial transparency",
  selected = ifelse(
    sum(organization_data$data[8,4]) == 0, "Doesn’t engage in financial transparency",
    as.character(organization_data$data[8,][which(organization_data$data[8,4] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Engages in financial accountability",
  selected = ifelse(
    sum(organization_data$data[9,4]) == 0, "Doesn’t engage in financial accountability",
    as.character(organization_data$data[9,][which(organization_data$data[9,4] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Many small private donations",
  selected = ifelse(
    sum(organization_data$data[10:11,4]) == 0, "Many small private donations",
    as.character(organization_data$data[10:11,][which(organization_data$data[10:11,4] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Friendly relationship with government",
  selected = ifelse(
    sum(organization_data$data[12:13,4]) == 0, "Friendly relationship with government",
    as.character(organization_data$data[12:13,][which(organization_data$data[12:13,4] == 1), 1])
  ),
  width = "450px"
)
})
...
selectInput(
  ...
  choice = c("Amnesty International", "Greenpeace", "Oxfam", "Red Cross"),
  # selected = "Red Cross",
  selected = as.character(organization_data$data[1:4,][which(organization_data$data[1:4,5] == 1), 1]),
  width = "450px"
)
...
selectInput(
  ...
  selected = ifelse(
    sum(organization_data$data[5:7,5]) == 0, "Emergency response",
    as.character(organization_data$data[5:7,][which(organization_data$data[5:7,5] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Engages in financial transparency",
  selected = ifelse(
    sum(organization_data$data[8,5]) == 0, "Doesn’t engage in financial transparency",
    as.character(organization_data$data[8,][which(organization_data$data[8,5] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Engages in financial accountability",
  selected = ifelse(
    sum(organization_data$data[9,5]) == 0, "Doesn’t engage in financial accountability",
    as.character(organization_data$data[9,][which(organization_data$data[9,5] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Many small private donations",
  selected = ifelse(
    sum(organization_data$data[10:11,5]) == 0, "Many small private donations",
    as.character(organization_data$data[10:11,][which(organization_data$data[10:11,5] == 1), 1])
  ),
  width = "450px"
)
...
selectInput(
  ...
  # selected = "Friendly relationship with government",
  selected = ifelse(
    sum(organization_data$data[12:13,5]) == 0, "Friendly relationship with government",
    as.character(organization_data$data[12:13,][which(organization_data$data[12:13,5] == 1), 1])
  ),
  width = "450px"
)
})
...
observeEvent(eventExpr = input$org_apply,
  handlerExpr = {
      ...
      file <- read_csv(input$org_update$datapath)
