...
# organization_data <- reactive({
#   org_file_input <- input$org_update
#   if (is.null(org_file_input)) {
#     organization_data <- org_default
#   } else {
#     req(input$org_update)
#     eventReactive(input$org_button, {
#       organization_data <- read_csv(input$org_update$datapath)
#     })
#   }
# })
# 
# organization_data <- reactive({
#   organizaiton_data <- org_default
# })
# 
# eventReactive(input$org_button, {
#   req(input$org_update)
#   organization_data$data <- read_csv(input$org_update$datapath)
# })
...
conditionalPanel(condition = 'input.what_config == "User input"',
                 fileInput(
                   "org_update",
...
organization_data <- reactive({
  if (input$what_config == "Default") {
    x <- org_default
  } else {
    if (input$what_config == "User input") {
...
# organization_data <- reactiveValues(data = NULL)
