...
p <- reactive({
  ...
  #Greenpeace
    ...
    beta$p2_value[beta$levels %in% input$gp_issue] <- 1
    beta$p2_value[beta$levels %in% input$gp_fin_trans] <- 1
    beta$p2_value[beta$levels %in% input$gp_account] <- 1
    beta$p2_value[beta$levels %in% input$gp_funding] <- 1
    beta$p2_value[beta$levels %in% input$gp_gov_relat] <- 1
  #Oxfam
    beta$p3_value <- 0
    beta$p3_value[beta$levels == 'Persona 3'] <- 1
    beta$p3_value[beta$levels %in% input$ox_issue] <- 1
    beta$p3_value[beta$levels %in% input$ox_fin_trans] <- 1
    beta$p3_value[beta$levels %in% input$ox_account] <- 1
    beta$p3_value[beta$levels %in% input$ox_funding] <- 1
    beta$p3_value[beta$levels %in% input$ox_gov_relat] <- 1
    beta
