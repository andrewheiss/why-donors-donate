...
persona_data <- reactive({
  if (is.null(input$per_update$datapath)) {
    ...
    # persona_values$file_name = "persona_config01.csv"
    # persona_values$file_type = "csv"
    # persona_values$file_size = file.size(here::here('analysis', 'output', 'configurations', 'persona_config01.csv'))
    # persona_values$file_path = here::here('analysis', 'output', 'configurations', 'persona_config01.csv')
  } else {
    persona_data <- read_csv(input$per_update$datapath)
    # persona_values$file_name = input$per_update$name
    # persona_values$file_size = input$per_update$size
    # persona_values$file_type = input$per_update$type
    # persona_values$file_path = input$per_update$datapath
  }
})
...
# Render the organization configurations as a table
renderTable({
  org_import = read_csv(input$org_update$datapath)
...
# Render the persona configurations as a table
renderTable({
  per_import = read_csv(input$per_update$datapath)
