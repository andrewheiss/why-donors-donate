...
test_beta <- as.data.frame(matrix(rep(0), nrow = 12))

test_beta$levels = c("Persona 1", "Persona 2", "Persona 3", "input1", "input2", "input3", "input4", "input5", "input6", "input7", "input8", "input9")
...
selectInput("p1_humanitarian_member",
         label = "Humanitarian organization membership:",
