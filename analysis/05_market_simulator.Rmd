...
beta <- as.data.frame(matrix(rep(0), nrow = 28))

beta$levels = c("Persona 1", "Persona 2", "Persona 3", "Chartiy Importance", "Trust in Charity", "Donation Frequency", "Donation Amount", "Volunteer 12 Months", "filler","filler", "filler", "filler", "filler", "filler","filler", "filler", "filler", "filler", "filler","filler", "filler", "filler", "filler", "filler","filler", "filler", "filler", "filler")
