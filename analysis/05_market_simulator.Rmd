...
selectInput("p1_travel_developing",
         ...
         choices = c('Does Travel', "Doesn't Travel"))
...
selectInput("p1_volunteer_12",
         ...
         choices = c("Volunteered", "Not Volunteered"))
...
#         min = 0,
#         max = 100,
#         gaugeSectors(colors = "#b50909"),
#         symbol = "%")
# })
```

```{r plot ai plot commented}
# renderPlotly({
#   choice = df()
#   
