...
renderPlotly({
  ...
  per_choice = p()
    ...
    p_beta1 <- as.matrix(public_political_social_charity_demo) %*% exp(as.matrix(persona1) %*% t(per_choice[,3]))
#add step to matrix multiply the persona reactive element to the persona data and the public_political beta table.
  ...
  rc_rate1 <- round(100 * rc_exp_util1/sum(ai_exp_util1, gp_exp_util1, ox_exp_util1, rc_exp_util1))
    ...
    # p_beta2 <- as.matrix(public_political_social_charity_demo) %*% (t(per_choice[,4]) %*% as.matrix(persona2))
  ...
  rc_rate2 <- round(100 * rc_exp_util2/sum(ai_exp_util2, gp_exp_util2, ox_exp_util2, rc_exp_util2))
    ...
    # p_beta3 =  as.matrix(public_political_social_charity_demo) %*% (t(per_choice[,5]) %*% as.matrix(persona3))
