...
p <- reactive({
  ...
  #Persona 1
    ...
    # beta_persona$p1_value[beta_persona$levels %in% input == '0'] <- 0
    # beta_persona$p1_value[beta_persona$levels %in% input == '1'] <- 1
    # beta_persona$p1_value[beta_persona$levels %in% input == '2'] <- 2
    # beta_persona$p1_value[beta_persona$levels %in% input == '3'] <- 3
    # beta_persona$p1_value[beta_persona$levels %in% input == '4'] <- 4
    # beta_persona$p1_value[beta_persona$levels %in% input == '5'] <- 5
    # beta_persona$p1_value[beta_persona$levels %in% input == '6'] <- 6
    # beta_persona$p1_value[beta_persona$levels %in% input == '7'] <- 7
    ...
    beta_persona$p1_value[beta_persona$levels == "Political Preference"] = p1_pol_pref()
  ...
  #Persona 3
    ...
    # 
    # beta_persona$p3_value[beta_persona$levels == "Political Preference"] <- input$p3_political_pref
...
df$p1[df$levels == "Rating"] = p1_pol_pref()
