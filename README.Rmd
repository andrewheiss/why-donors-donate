...
If you're part of the research team and using Dropbox, make sure you make it so that Dropbox ignores the `posterior_draws` folder. There are [complete instructions for doing that here](https://help.dropbox.com/files-folders/restore-delete/ignored-files). In short, run one of these commands in your terminal:
