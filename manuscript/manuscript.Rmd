...
- First set of questions (hypotheses) can be answered using the results of the intercept-only model.
...
![Combined Results](output/figures/combined-results.png)



The following plots zoom in on the strength of the effects that these characteristics have.


Compared to when an NGO has a friendly relationship with the host government, donors are much less likely to donate when government is under crackdown or criticized.



![Relationship With Host Government](output/figures/relationship-with-gov.png)

Donors are more likely to donate when organizations are accountable and financially transparent.

![Organizational Characteristics: Managerial Practices](output/figures/managerial-practices.png)
...
![Organizational Characteristics: Funding Sources](output/figures/funding-sources.png)
...
![Organizational Characteristics: Issue Areas](output/figures/issue-areas.png)

All organizations were positively percieved by respondents. The Red Cross was significantly more favored.


![Organization](output/figures/organization.png)


- Second set of questions (confirmatory) can be answered using the following upper-level models:
...
![](output/figures/charity-and-volunteerism.png)  
...
- Third set of questions (exploratory) can be answered using a market simulator.
