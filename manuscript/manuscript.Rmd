...
The following plots zoom in on how strongly each of the attributes serve as heuristics. 



![Relationship With Host Government](output/figures/relationship-with-gov.png)
Donors are less likely to donate when government is under crackdown than when it is criticized. In both cases, there is a clear negative effect.
...
Donors are less likely to donate when an NGO is subsidized by government grants, and even less likely when an NGO is funded by a few private donors. (look further into demographic info to see if there is any explanation or insight there)

![Organizational Characteristics: Issue Areas](output/figures/issue-areas.png)
* Emergency response is mentioned in Hypothesis but isn't included in plot?
Issue Areas 

![Organization](output/figures/organization.png)
All organizations were percieved positively by respondents. The Red Cross was significantly more favored.
